            ...
            {step === 1 && (
              <div className="space-y-8">
                {needsAuth ? (
                  ...
                  <div className="space-y-8">
                    {/* Customer Info & Shipping Address Form */}
                    <div className="bg-white rounded-2xl border border-[#1F0505]/15 p-6 sm:p-8 shadow-sm space-y-6">
                      <div className="flex items-center justify-between pb-3 border-b border-[#1F0505]/10">
                        <div className="flex items-center gap-3">
                          <Truck className="h-5 w-5 text-[#1F0505]" strokeWidth={1.5} />
                          <h2 className="font-serif text-[24px] sm:text-[28px] text-[#1F0505]">Shipping & Delivery Details</h2>
                        </div>
