...
export default function HomePage() {
  ...
  const HERO_SLIDES = [
    ...
    {
      id: 2,
      image: '/images/editorial/couture_gold_mirror.jpg',
      tagline: "GILDED BRIDAL TROUSSEAU",
      title: "Lustre of\nPure Zari.",
      subtitle: "Handcrafted mirrorwork and heavy zardozi embroidery over heirloom silks.",
      cta: "DISCOVER LOOKBOOK",
      link: "/lookbook",
    },
    {
      id: 3,
    ...
    {
      id: 4,
      image: '/images/editorial/rolls_brocade.jpg',
      tagline: "WEFT & WARP HERITAGE",
      title: "Looms of\nTradition.",
      subtitle: "Directly sourced from Varanasi and Kanchipuram master weavers.",
      cta: "EXPLORE BROCADES",
      link: "/shop/heritage",
    },
    {
      id: 5,
  ...
  return (
    <>
      ...
      {/* ══════════════════════════════════════════════════════════════════
          ATELIER VISUAL GALLERY — DENSE COUTURE & FABRIC SHOWCASE
      ══════════════════════════════════════════════════════════════════ */}
      <section className="bg-[#F5F0EB] py-16 md:py-24 px-6 md:px-12 border-b border-[#1F1916]/10" aria-label="Atelier Visual Gallery">
        <div className="max-w-[1340px] mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
            <div>
              <span className="font-sans text-[10px] tracking-[0.25em] text-[#1F1916]/50 uppercase font-semibold">
            ...
            <Link
              ...
              className="font-sans text-[11px] font-semibold tracking-[0.2em] text-[#1F1916] uppercase hover:underline underline-offset-4"
            >
              Explore Complete Lookbook &rarr;
            </Link>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <Link to="/lookbook" className="group rounded-2xl overflow-hidden aspect-[3/4] bg-[#E8E2DB] relative shadow-sm">
              <img
              ...
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <span className="text-[8px] font-sans tracking-widest uppercase text-white/80 block">TROUSSEAU</span>
                <p className="font-serif text-[16px] font-medium leading-snug">Zardozi & Mirrorwork</p>
              </div>
            </Link>
            ...
            <Link to="/lookbook" className="group rounded-2xl overflow-hidden aspect-[3/4] bg-[#E8E2DB] relative shadow-sm">
              <img
                ...
                alt="Aubergine Resham Bridal Lehenga"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-80 group-hover:opacity-95 transition-opacity" />
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <span className="text-[8px] font-sans tracking-widest uppercase text-white/80 block">ROYAL SILK</span>
                <p className="font-serif text-[16px] font-medium leading-snug">Aubergine Kalidar</p>
              </div>
            </Link>
            ...
            <Link to="/lookbook" className="group rounded-2xl overflow-hidden aspect-[3/4] bg-[#E8E2DB] relative shadow-sm">
              <img
                ...
                alt="Vibrant Brocade Bolts"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-80 group-hover:opacity-95 transition-opacity" />
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <span className="text-[8px] font-sans tracking-widest uppercase text-white/80 block">HERITAGE WEAVE</span>
                <p className="font-serif text-[16px] font-medium leading-snug">Banarasi Brocades</p>
              </div>
            </Link>
            ...
            <Link to="/lookbook" className="group rounded-2xl overflow-hidden aspect-[3/4] bg-[#E8E2DB] relative shadow-sm">
              <img
                ...
                alt="Olive Organza Anarkali"
                className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-80 group-hover:opacity-95 transition-opacity" />
              <div className="absolute bottom-4 left-4 right-4 text-white">
                <span className="text-[8px] font-sans tracking-widest uppercase text-white/80 block">CONTEMPORARY</span>
                <p className="font-serif text-[16px] font-medium leading-snug">Olive Garden Organza</p>
              </div>
            </Link>
          </div>
        </div>
