...
export default function StatsStrip() {
  return (
    <section className="relative overflow-hidden bg-[#1F0505] py-12 sm:py-16">
      <span className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[#FFE6E9]/30" aria-hidden="true" />
      ...
      <span className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-[#FFE6E9]/30" aria-hidden="true" />
    </section>
  );
}
